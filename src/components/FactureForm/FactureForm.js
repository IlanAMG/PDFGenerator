...
import { renderPDFInDomFact } from '../PdfFacture/PdfFacture';
            ...
            <form className='wrap-form' onSubmit={handleSubmit}>
                <div className='container-form'>
                    <div className='container-infosdevis'>
                        ...
                        <InputText placeholder='Date de la facture' label='Date de la facture :' name='date' value={infos.date} onChange={handleChange}/>
                ...
                <button onClick={() => renderPDFInDomFact(infos, produits, url, footer)}>Générer la Facture en PDF</button>
            </form>
        </>
    )
}
